# Milestones: Pocket Monsters Sapphire

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-Sapphire-Decompilation`.
...
| Field | Current value |
| --- | --- |
| Target | Pocket Monsters Sapphire |
...
Compare shared Generation III structures with Ruby and Emerald without assuming identical layouts.
